...
class ClassAttributesFrame(QFrame):
    """
        Class that creates a frame that contains all class attributes widgets
    """
    ...
    def __setupStyleSheet(self) -> None:
        ...
        self.baseClassAttributesFrame = self.__createDefaultFrame()
    ...
    def __createDefaultFrame(self) -> QFrame:
